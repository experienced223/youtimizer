			...
			<td colspan="6" class="actions">
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php _e( 'Coupon code', LANGUAGE_ZONE ); ?>" /> <input type="submit" class="button btn style2" name="apply_coupon" value="<?php _e( 'Apply Coupon', LANGUAGE_ZONE ); ?>" />
				...
				<input type="submit" class="button btn style2" name="update_cart" value="<?php _e( 'Update Cart', LANGUAGE_ZONE ); ?>" />
