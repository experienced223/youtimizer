...
<h2 class="nav-tab-wrapper">  
    ...
    <a href="<?php echo admin_url('admin.php'); ?>?page=fcmdpplgpn_push_notification&tab=test_fcm" class="nav-tab <?php echo $active_tab == 'test_fcm' ? 'nav-tab-active' : ''; ?>">Youtimizer Weekly Gain Push Notification</a>  
</h2>
...
<div>    
    <h2><?php echo __("Send a notification", FCMDPPLGPN_TRANSLATION);?></h2>
    <p><?php echo __("The Firebase API key and topic need to be entered in FCM Options.",FCMDPPLGPN_TRANSLATION);?></p>
    <a href="<?php echo admin_url('admin.php'); ?>?page=test_push_notification"><?php echo __("Click here to send a notification", FCMDPPLGPN_TRANSLATION);?></a>
</div>
