...
<p>
	<label for="widget-title"><?php _e( 'Title:', 'pressapps-modal-login' ); ?></label>
...
<p>
	<label for="login-text"><?php _e( 'Login Text:', 'pressapps-modal-login' ); ?></label>
...
<p>
	<label for="logout-text"><?php _e( 'Logout Text:', 'pressapps-modal-login' ); ?></label>
...
<p>
	<label for="show-admin"><?php _e( 'Show Admin Link:', 'pressapps-modal-login' ); ?></label>
