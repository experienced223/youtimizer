...
$i++;
$cfg['Servers'][$i]['host'] 			= 'youtimizer.com.mysql';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '?!v4ROmCZM]@UJt76e\"U*+H7;7y*=a@R' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_BSVI1xeKsyhWl5wtfdJzGAb/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
